...
class DummyLocalStorage extends EventEmitter {
   ...
   * @returns {void}
   */
  removeItem(keyName: keyof typeof this._storage) {
 ...
 */
class AppLocalStorage extends EventEmitter {
  _storage: Storage | DummyLocalStorage;
  _localStorageDisabled: boolean | undefined;
  /**
   * @constructor
   ...
   */
  setItem(keyName: string, keyValue: any, dontEmitChangedEvent = false) {
